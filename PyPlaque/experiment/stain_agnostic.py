...
class StainAgnostic:
  ...
  Attributes:
    ...
    params (dict, optional): A dictionary of parameters for stain agnostic plaques, thresholding, 
  ...
  def get_params(self):
    """
    **get_params Method** 
    Returns the parameters currently saved in the StainAgnostic class.
  ...
  def read_from_path(self,
    ...
    **read_from_path Method**
    ...
    ```
    image = pyplaque.Experiment.StainAgnostic.read_from_path(image_path)
    ```
